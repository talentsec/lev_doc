...
```bash
curl -O https://raw.githubusercontent.com/talentsec/lev_installation/main/lev_installation_for_centos_7.sh && chmod +x lev_installation_for_centos_7.sh && ./lev_installation_for_centos_7.sh
```
