...
2. Install the libraries and dependencies required for compilation. Prerequisite tools and libraries may differ for different Linux distributions, please check based on the package name: libssl , libffi.
